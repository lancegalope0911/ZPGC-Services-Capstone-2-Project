...
function showError($error) {
    return !empty($error) ? "<div style='padding:12px; background-color: #ffbbc0; color: #ff0011; border-radius:6px; text-align:center; margin-bottom:20px; color:#7e030b; font-weight:600; font-size: 14px; width:100%;'>$error</div>" : '';
}
