...
/*
 * FILE: admin.php
 * PURPOSE: Dashboard for users with role 'admin'.
 * NAV:     Dashboard, Utilities, Analytics, Messages, Settings, Logout
 * SHARED:  Same layout/CSS/JS as user.php and techn.php.
 */
            ...
            <div class="main-nav">
                <nav class="navbar">
                    <div class="navbar-nav">
                        ...
                        <!-- NAV: admin-only items = Utilities, Analytics -->
                        <ul class="nav-list">
                            ...
                            <li class="nav-list-item">
                                <a href="#" class="nav-link">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="-1 0 24 24">
