...
/*
 * FILE: techn.php
 * PURPOSE: Dashboard for users with role 'techn' (technician).
 * NAV:     Dashboard, Tickets, Messages, Settings, Logout
 * SHARED:  Same layout/CSS/JS as user.php and admin.php.
 */
            ...
            <div class="main-nav">
                <nav class="navbar">
                    <div class="navbar-nav">
                        ...
                        <!-- NAV: techn shares Tickets with user; no Home, Utilities, or Analytics -->
                        <ul class="nav-list">
